...
// func (m *Mysql) CountApplication(status models.ApplicationStatusFilter) (int, error) {
...
// func (m *Mysql) FindAllApplication(status models.ApplicationStatusFilter) ([]response.Application, error) {
// 	ctx, cancel := context.WithTimeout(context.Background(), time.Second*5)
// 	defer cancel()
//
